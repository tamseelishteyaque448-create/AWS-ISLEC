...
- Name: auth.spec.ts >> Authentication & Authorization Runtime Verification >> AUTH-03: Anonymous /member/projects access denied
...
Expected substring: "next=/member/projects"
Received string:    "http://localhost:3000/join?mode=login&next=%2Fmember%2Fprojects"
```
