...
- Name: auth.spec.ts >> Authentication & Authorization Runtime Verification >> AUTH-01: Anonymous /member access redirects to login
...
Expected substring: "next=/member"
Received string:    "http://localhost:3000/join?mode=login&next=%2Fmember"
```
