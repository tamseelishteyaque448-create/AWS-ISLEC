...
export default async function PublicEventsPage() {
  ...
  const upcoming = events?.filter((event) => event.effectiveStatus === "upcoming") ?? [];
  const past = events?.filter((event) => event.effectiveStatus === "past") ?? [];
